...
dub_void startReader(dub_char*, dub_char*, dub_char, dub_int, dub_int);
...
dub_int mainReader(dub_int argc, dub_char** argv) {
	...
	dub_char* program = argv[0];
	dub_char* input = argv[2];
	dub_char mode = MODE_FIXED;
	dub_int size = 0, increment = 0, wrongNumber = 0;
...
************************************************************
*/
dub_void startReader(dub_char* program, dub_char* input, dub_char mode, dub_int size, dub_int increment) {

	ReaderPointer bufferp;		/* pointer to Buffer structure */
	FILE* fileHandler;			/* input file handle */
	dub_int loadSize = 0;		/* the size of the file loaded in the buffer */
	dub_char symbol;			/* symbol read from input file */
